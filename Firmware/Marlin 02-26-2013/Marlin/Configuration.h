...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2268,550}  // default steps for SAE ecksbot
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,550}  // default steps for metric ecksbot
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3, 45}    // (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {2800,2800,3,2800}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
